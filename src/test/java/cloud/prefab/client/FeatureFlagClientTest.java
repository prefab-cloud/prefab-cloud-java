...
public class FeatureFlagClientTest {
  ...
  public void testPct() {
    ...
    assertThat(featureFlagClient.isOnFor(flag, feature, Optional.of("hashes high"), Maps.newHashMap(),variants)).isFalse();
    assertThat(featureFlagClient.isOnFor(flag, feature, Optional.of("hashes low"), Maps.newHashMap(),variants)).isTrue();
  }
  ...
  public void testOff() {
    ...
    assertThat(featureFlagClient.isOnFor(flag, feature, Optional.of("hashes high"), Maps.newHashMap(),variants)).isFalse();
    assertThat(featureFlagClient.isOnFor(flag, feature, Optional.of("hashes low"), Maps.newHashMap(),variants)).isFalse();
  ...
  public void testOn() {
    ...
    assertThat(featureFlagClient.isOnFor(flag, feature, Optional.of("hashes high"), Maps.newHashMap(),variants)).isTrue();
    assertThat(featureFlagClient.isOnFor(flag, feature, Optional.of("hashes low"), Maps.newHashMap(),variants)).isTrue();
