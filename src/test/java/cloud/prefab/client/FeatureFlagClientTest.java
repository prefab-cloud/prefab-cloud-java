...
public class FeatureFlagClientTest {
  ...
  public void testEndsWith() {
    final Prefab.Criteria socialEmailCritieria = Prefab.Criteria
      .newBuilder()
      .setProperty("email")
      .addValues("gmail.com")
      .addValues("yahoo.com")
    ...
    assertThat(
      featureFlagClient.criteriaMatch(
        socialEmailCritieria,
        Optional.empty(),
        ImmutableMap.of("email", "bob@example.com")
      )
    )
      .isFalse();
    assertThat(
      featureFlagClient.criteriaMatch(
        socialEmailCritieria,
        Optional.empty(),
        ImmutableMap.of("email", "alice@yahoo.com")
      )
    )
      .isTrue();
    assertThat(
      featureFlagClient.criteriaMatch(
        socialEmailCritieria,
        Optional.empty(),
        ImmutableMap.of("email", "alice@gmail.com")
      )
    )
      .isTrue();
  }
