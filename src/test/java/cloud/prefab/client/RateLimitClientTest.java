...
public class RateLimitClientTest {
  ...
  public void isPassAddsAccountId() {
    ...
    rateLimitClient.isPass(Prefab.LimitRequest.newBuilder()
        .setAcquireAmount(1)
        .addGroups("test.group")
        .build());

    Prefab.LimitRequest expectedRemoteCall = Prefab.LimitRequest.newBuilder()
        .setAcquireAmount(1)
        .setAccountId(54321L)
        .addGroups("test.group")
        .build();
  ...
  public void acquireCalledTwiceCaches() {
    ...
    boolean pass = rateLimitClient.isPass(Prefab.LimitRequest.newBuilder()
        .setAcquireAmount(1)
        .addGroups("test.group")
        .build());
    assertThat(pass).isTrue();

    pass = rateLimitClient.isPass(Prefab.LimitRequest.newBuilder()
        .setAcquireAmount(1)
        .addGroups("test.group")
        .build());
