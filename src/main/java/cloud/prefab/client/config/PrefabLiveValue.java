...
public abstract class PrefabLiveValue<T> extends LiveValue {
  ...
  public PrefabLiveValue(String key, ConfigResolver configResolver, Function<Prefab.ConfigValue, T> transform) {
    super(null, key, null);
  ...
  public Optional<T> getMaybe() {
    final java.util.Optional<Prefab.ConfigValue> configValue = configResolver.getConfigValue(key);
